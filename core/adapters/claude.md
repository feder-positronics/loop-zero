...
instruction entry point; preserve its imports and product skills. `loopzero
sync` generates the declared canonical skill directory and relative mirrors;
check the active runtime's loading behavior rather than assuming discovery.
